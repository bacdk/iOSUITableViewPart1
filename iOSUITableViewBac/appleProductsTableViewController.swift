...
class appleProductsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        //Create a Cell
        let cell = tableView.dequeueReusableCell(withIdentifier: "idProductsCell", for: indexPath)
        //Create a product follow the indexPath.row
        let product = products[indexPath.row]
        //Show product on cell
